 ...
 * @require 1
 *
 * @command SetPauseSignOffsetX
 * @text Xオフセット変更
 * @desc ポーズサインのX軸方向のオフセットを変更します。
 *
 * @arg offsetX
 * @text Xオフセット値
 * @type number
 ...
 * @default 0
 * 
 * @command SetPauseSignOffsetY
 * @text Yオフセット変更
 * @desc ポーズサインのY軸方向のオフセットを変更します。
 *
 * @arg offsetY
 * @text Yオフセット値
 * @type number
...
(() => {
  ...
  if (PluginManager._scripts.contains("NobleMushroom")) {
    ...
    PluginManager.registerCommand("UTSU_PauseSignEx", "SetPauseSignOffsetX", args => {
        params.pauseSignOffsetX = Number(args.offsetX || 0);
    });
    PluginManager.registerCommand("UTSU_PauseSignEx", "SetPauseSignOffsetY", args => {
        params.pauseSignOffsetY = Number(args.offsetY || 0);
    });
